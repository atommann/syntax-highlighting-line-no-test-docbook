...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xslthl="http://xslthl.sf.net" exclude-result-prefixes="xslthl" version="1.0">
  ...
  <xsl:template match="xslthl:keyword" mode="xslthl">
    <strong class="hl-keyword" style="color: #000000">
      <xsl:apply-templates mode="xslthl"/>
    </strong>
  </xsl:template>
  <xsl:template match="xslthl:string" mode="xslthl">
    <strong class="hl-string">
      <em style="color: #0000ff">
        <xsl:apply-templates mode="xslthl"/>
      </em>
    </strong>
  </xsl:template>
  ...
  <xsl:template match="xslthl:directive" mode="xslthl">
    <span class="hl-directive" style="color: 800000">
      <xsl:apply-templates mode="xslthl"/>
    </span>
  </xsl:template>
  ...
  <xsl:template match="xslthl:value" mode="xslthl">
    <span class="hl-value" style="color: #0000ff">
      <xsl:apply-templates mode="xslthl"/>
    </span>
  </xsl:template>
  ...
  <xsl:template match="xslthl:number" mode="xslthl">
    <span class="hl-number" style="color: #0000ff">
      <xsl:apply-templates mode="xslthl"/>
    </span>
  </xsl:template>
